...
namespace ompl
{
    namespace app
    {
        ...
        */
        ...
        public:
            QuadrotorPlanning()
                : AppBase<CONTROL>(constructControlSpace(), Motion_3D), timeStep_(1e-2), massInv_(1.), beta_(1.), odeSolver (control::ODEBasicSolver <>(si_, boost::bind(&ompl::app::QuadrotorPlanning::ode, this, _1, _2, _3)))
            {
