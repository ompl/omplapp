...
- Added several new and updated planners:
  ...
  - [Informed RRT*](\ref gInformedRRTstar):
  - [Batch Informed Trees (BIT*)](\ref gBITstar): an anytime asymptotically optimal sampling-based motion planning algorithm that extends Lifelong Planning A* (LPA*) techniques to continuous planning.
